...
namespace TMS.APIs
{
    ...
    public class LessonTypesController : Controller
    {
        ...
        //*************************************************************************
        // GET api/AppNotes/GetLessonTypesPageByPage
        //*************************************************************************
        [Authorize("ADMIN")]
        [HttpGet("GetLessonTypesPageByPage")]
        public JsonResult GetLessonTypesPageByPage([FromQuery]QueryPagingParametersForLessonTypes inParameters)
        {
            int pageSize = 10;
            int totalPage = 0;
            int startRecord = 0;
            ...
            // EXEC dbo.uspSelectLessonTypes @pageNo =1,
            ...
            if (dr.HasRows)
            {
                while (dr.Read())
                {
                    ...
                    //totalRecords variable not included insdie the anonymous type 

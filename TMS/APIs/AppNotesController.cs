...
namespace TMS.APIs
{
    ...
    public class AppNotesController : Controller
    {
        ...
        //*************************************************************************
        // GET api/AppNotes/GetNotesPageByPage
        //*************************************************************************
        [Authorize("ADMIN")]
        [HttpGet("GetNotesPageByPage")]
        public JsonResult GetNotesPageByPage( [FromQuery]QueryPagingParametersForNotes inParameters)
        {
            int pageSize = 10;
            int totalPage = 0;
            int startRecord = 0;
    ...
    //Setup a class QueryPagingParametersForNotes so that we can have cleaner code
